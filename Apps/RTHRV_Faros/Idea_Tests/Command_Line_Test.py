...
def parseargv(argDict, argv, helpdescription=None):
    ...
    * helpdescription is the description string to display in the
          help text
    * To add a flag arg (i.e. one with no value), set default_value = None.
          It will be returned True if called in the command line."""
    ...
    errorString = ("\nError:"
                   ...
                   "\n    LivePlotting_Process_Commandline.py -x <val> --xlong <val>"
...
if __name__ == "__main__":
    ...
    filename = "LivePlotting_Process_Commandline.py"
    ...
    helpdecription = "Plots a 1-channel numeric stream from Lab Streaming Layer"
    argDict = parseargv(argDict, sys.argv[1:], helpdescription=helpdecription)
